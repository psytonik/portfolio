...
import {Flex, HStack, LinkBox, Tooltip, useColorModeValue, VStack, Text, Box, Tag} from "@chakra-ui/react";
import {Icon} from "@chakra-ui/icons";
import {FiGithub} from "react-icons/fi";
import {BiGitRepoForked, BiStar} from 'react-icons/bi';

const GithubCard = ({ name, description, language, url, stargazers_count, forks_count }:any) => {
	return (
